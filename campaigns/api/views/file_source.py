...
from campaigns.models import FileSource, Document
from campaigns.serializers import DocumentFactoryReportSerializer
...
class FileSourceCreate(generics.CreateAPIView):
    ...
    @swagger_auto_schema(
        responses={
            status.HTTP_200_OK: openapi.Response(
                ...
                schema=DocumentFactoryReportSerializer
            )
        }
    )
    def create(self, request, *args, **kwargs):
        ...
        output_serializer = DocumentFactoryReportSerializer(report)
